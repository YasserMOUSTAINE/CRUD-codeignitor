        ...
        <form action="<?= site_url('students/create') ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="niveau_etudes" name="niveau_etudes" required>
                    ...
                    <option value="bac" <?= old('niveau_etudes') == 'bac' ? 'selected' : '' ?>>Bac</option>
                    ...
                    <option value="bac+3" <?= old('niveau_etudes') == 'bac+3' ? 'selected' : '' ?>>Bac+3</option>
                    <option value="bac+4" <?= old('niveau_etudes') == 'bac+4' ? 'selected' : '' ?>>Bac+4</option>
                    <option value="bac+5" <?= old('niveau_etudes') == 'bac+5' ? 'selected' : '' ?>>Bac+5</option>
                </select>
            </div>
